...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Username', 'Password', 'FirstName', 'LastName', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('username', 'password', 'firstName', 'lastName', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::USERNAME, self::PASSWORD, self::FIRST_NAME, self::LAST_NAME, self::EMAIL, ),
		BasePeer::TYPE_FIELDNAME => array ('username', 'password', 'first_name', 'last_name', 'email', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Username' => 0, 'Password' => 1, 'FirstName' => 2, 'LastName' => 3, 'Email' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('username' => 0, 'password' => 1, 'firstName' => 2, 'lastName' => 3, 'email' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::USERNAME => 0, self::PASSWORD => 1, self::FIRST_NAME => 2, self::LAST_NAME => 3, self::EMAIL => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('username' => 0, 'password' => 1, 'first_name' => 2, 'last_name' => 3, 'email' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in DesignPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Design objects
			$c = new Criteria(DesignPeer::DATABASE_NAME);
			
			$c->add(DesignPeer::OWNER, $obj->getUsername());
			$affectedRows += DesignPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
